...
FCKConfig.ToolbarSets["Default"] = [
	['Preview','FitWindow','-','Cut','Copy','Paste','PasteText','-','Print','Undo','Redo'],
	'/',
...
FCKConfig.ToolbarSets["Basic"] = [
	['Preview','FitWindow','-','Cut','Copy','Paste','PasteText','-','Print','Undo','Redo','FontName','FontSize'],
	'/',
	['Bold','Italic','Underline'],
	['OrderedList','UnorderedList'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','Link'],
	['Table','Rule','TextColor','BGColor']
] ;
