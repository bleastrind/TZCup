...
%>
<bean:message key="index.loginbox.welcome"></bean:message>：<strong><%=name%></strong>!
...
<form id="indexloginform" action="<%=path%>/loginoprate.do?from=index" method="post">
	<div id="formcontent">
		<table>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input value="<bean:message key="index.loginbox.login"></bean:message>" type="submit" class="buttonsubmit" />
